...
//              bool matchedADCandTDC,
    ...
    void SetHighGainADC(unsigned int highGainADC);
    void SetLowGainADC(unsigned int highGainADC);

    /// Return the GTS time.  (20 bit value, 10 us resolution)
    unsigned int GetGTSCounter() const;
...
//    virtual void ls(Option_t* opt = "") const;
    unsigned int GetTimeOverThreshold() const;

    unsigned int GetTimeFromGateStart() const;
