...
//    void SetPreviousSpill(bool prSpillEx = false, unsigned int prSpill=0);
    ...
    bool GateTimeFrGTSEx()                                  {return _gateTimeFrGtsEx;}
    unsigned int GetGateTimeFrGTS() const                   {return _gateTimeFrGtsEx ? _gateTimeFrGts : 0;}
    ...
    unsigned int GetFirstGTSTag() const                   {return _firstGtsTag;}
...
private:
    ...
    bool _isFirstGtsTag{true};
    unsigned int _firstGtsTag{0};
